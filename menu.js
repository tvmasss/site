document.addEventListener("DOMContentLoaded", function() {
    ...
    const footerContainer = document.getElementById('footer-menu-placeholder');
    
    if (footerContainer) {
        footerContainer.innerHTML = footerMenuHTML;

        const currentPath = window.location.pathname;
        const footerLinks = footerContainer.querySelectorAll('#footer-menu a');
