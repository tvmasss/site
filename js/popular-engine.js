document.addEventListener("DOMContentLoaded", async function() {
    ...
    try {
        const response = await fetch('/js/popular.json'); 
        ...
        let html = '<div id="enjoylife-recent-2" class="widget widget-enjoylife-recent widget-posts-thumbnail"><h2 class="widget-title"><span>Популярные статьи</span></h2><div class="pop-list">';
